...
public class insertApplicantSenior implements Initializable {
...
@Override
    ...
    public void validation(){
        boolean fname=txtFname.getText().isEmpty();
        boolean lname=txtLname.getText().isEmpty();
        boolean age=txtAge.getText().isEmpty();
        boolean addresss=txtAddr.getText().isEmpty();


        if(fname=true){
            fnameWarn.setText("Enter First name");
    ...
    public void validateEmail() {
        if (txtEmail.getText().isEmpty() || txtEmail.getText().matches("[a-zA-Z0-9][a-zA-Z0-9._]*@[a-zA-Z0-9]+([.][a-zA-Z]+)+")) {
    ...
    public void validateContact() {
        if (txtNumber.getText().isEmpty() || txtNumber.getText().matches("[a-zA-Z]+")) {
